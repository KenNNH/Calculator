...
// Thiết lập giá trị hiện tại trên màn hình
function setDisplay(value) {
    display = parseFloat(value);
    document.getElementById('box').innerText = display;
}
// Chức năng của nút M+
function memoryPlus() {
    ...
    // Kiểm tra giá trị của memory sau khi thêm
...
function memoryMinus() {
    ...
    // Kiểm tra giá trị của memory sau khi trừ
    console.log("Memory after M-: ", memory);
}
// Chức năng của nút MR
function memoryRecall() {
    // Lấy giá trị từ bộ nhớ và hiển thị nó trên màn hình
    setDisplay(memory);

    // Log để kiểm tra việc gọi chức năng MR
    console.log("Memory recalled: ", memory);
}

// Chức năng của nút MC
